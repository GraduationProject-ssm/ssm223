...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1gn8XeNE2J?p=22)
...
|guzhangmiaoshu|longtext|是|NULL|故障描述|
...
|id (主键)|bigint(20)|否||主键|
|addtime|timestamp|否|CURRENT\_TIMESTAMP|创建时间|
|loufangmingcheng|varchar(200)|是|NULL|楼房名称|
|loufangjieshao|longtext|是|NULL|楼房介绍|
|loupanweizhi|varchar(200)|是|NULL|楼盘位置|
|loufangleixing|varchar(200)|是|NULL|楼房类型|
|loucengshuliang|int(11)|是|NULL|楼层数量|
|loupanjiage|int(11)|是|NULL|楼盘价格|
|loupanzhuangtai|varchar(200)|是|NULL|楼盘状态|
|zhaopian|varchar(200)|是|NULL|照片|
|gengxinshijian|datetime|是|NULL|更新时间|
|kaipanshijian|datetime|是|NULL|开盘时间|
...
|loufangmingcheng|varchar(200)|是|NULL|楼房名称|
|zhaopian|varchar(200)|是|NULL|照片|
|chuzuloufang|int(11)|是|NULL|出租楼房|
|yishouloufang|int(11)|是|NULL|已售楼房|
|shengyuloufang|int(11)|是|NULL|剩余楼房|
表4.6 楼盘类型
...
|qianfeijine|int(11)|是|NULL|欠费金额|
|zhinajin|int(11)|是|NULL|滞纳金|
|haixujiaofeijine|int(11)|是|NULL|还需缴费金额|
...
|xingming|varchar(200)|否||姓名|
|shouji|varchar(200)|是|NULL|手机|
|jiaofeizhuangtai|varchar(200)|是|NULL|缴费状态|
|shoufeishijian|datetime|是|NULL|收费时间|
表4.10 售户收费管理
...
|maifangshijian|date|是|NULL|买房时间|
|shuidianfei|int(11)|是|NULL|水电费|
|weishengqinglifei|int(11)|是|NULL|卫生清理费|
|tingchefei|int(11)|是|NULL|停车费|
|weixiufei|int(11)|是|NULL|维修费|
|xujiaojine|int(11)|是|NULL|需缴金额|
|ispay|varchar(200)|是|未支付|是否支付|
表4.11 收藏表
...
|shouji|varchar(200)|是|NULL|手机|
|tousurenyuan|varchar(200)|是|NULL|投诉人员|
...
|tongxindizhi|varchar(200)|是|NULL|通信地址|
|jiguan|varchar(200)|是|NULL|籍贯|
|shouji|varchar(200)|否||手机|
|shenfenzheng|varchar(200)|否||身份证|
|youxiang|varchar(200)|是|NULL|邮箱|
|ruzhuloufanghao|varchar(200)|否||入住楼房号|
|ruzhushijian|date|是|NULL|入住时间|
|qiyuejiaofangri|datetime|是|NULL|契约交房日|
|jinjilianxiren|varchar(200)|否||紧急联系人|
|jinjilianxidianhua|varchar(200)|否||紧急联系电话|
表4.16 用户
...
|shouji|varchar(200)|是|NULL|手机|
|loufanghao|varchar(200)|是|NULL|楼房号|
|zufangshijian|date|是|NULL|租房时间|
